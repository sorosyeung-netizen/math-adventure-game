...
function displayQuestion(num1, num2, operation, correctAnswer, wrongAnswer, type) {
    ...
    // Update question display with vertical layout for mobile
    questionDisplay.innerHTML = `
        <div class="emoji-equation-vertical">
            <div class="equation-line">
                <span class="emoji-count">${num1}</span>
                <div class="emoji-vertical">${emoji1Str}</div>
            </div>
            ...
            <div class="equation-line">
                ...
                <div class="emoji-vertical">${emoji2Str}</div>
            </div>
    ...
    // Update answer options with enhanced feedback
