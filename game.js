...
function displayQuestion(num1, num2, operation, correctAnswer, wrongAnswer, type) {
    ...
    // Update question display with vertical layout for mobile - enlarged emojis
    questionDisplay.innerHTML = `
        <div class="emoji-equation-vertical">
            <div class="equation-line">
                <span class="emoji-count" style="font-size: 2.5em; font-weight: bold;">${num1}</span>
                <div class="emoji-vertical" style="font-size: 2em; line-height: 1.2;">${emoji1Str}</div>
            </div>
            <div class="operator-line">
                <span class="operator-large" style="font-size: 2.5em; font-weight: bold;">${operation}</span>
            </div>
            <div class="equation-line">
                <span class="emoji-count" style="font-size: 2.5em; font-weight: bold;">${num2}</span>
                <div class="emoji-vertical" style="font-size: 2em; line-height: 1.2;">${emoji2Str}</div>
            </div>
            <div class="equals-line">
                <span class="equals-large" style="font-size: 2.5em; font-weight: bold;">=</span>
                <span class="question-mark-large" style="font-size: 2.5em; font-weight: bold;">?</span>
            </div>
        </div>
        <p class="instruction-vertical" style="font-size: 1.5em; margin: 20px 0;">Choose the correct number:</p>
    `;
    
    // Update answer options with enhanced feedback - enlarged buttons
    answerOptions.innerHTML = `
        <button class="answer-btn" style="font-size: 2.5em; font-weight: bold; padding: 20px 40px; margin: 10px;" onclick="checkAnswer(${correctAnswer}, ${shuffled[0]}, this)">
            ${shuffled[0]}
        </button>
        <button class="answer-btn" style="font-size: 2.5em; font-weight: bold; padding: 20px 40px; margin: 10px;" onclick="checkAnswer(${correctAnswer}, ${shuffled[1]}, this)">
            ${shuffled[1]}
        </button>
    `;
